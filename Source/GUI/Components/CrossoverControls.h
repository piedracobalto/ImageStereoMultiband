...
class CrossoverControls : public juce::Component,
                          private juce::AudioProcessorValueTreeState::Listener,
                          private juce::AsyncUpdater
{
public:
    explicit CrossoverControls(juce::AudioProcessorValueTreeState& apvts);
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(CrossoverControls)
};
