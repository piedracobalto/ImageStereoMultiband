...
**Propósito:** Genera los 25 parámetros del plugin. Itera 5 bandas creando Width (float 0–2), Gain (float -24–24 dB), Mute (bool), Solo (bool). Luego crea 4 crossovers (float 20–20000 Hz) con valores default (120, 500, 2000, 8000). Finalmente crea el bypass (bool).
